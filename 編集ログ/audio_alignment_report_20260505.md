...
- 差し替え候補一覧を作成: `編集ログ/phrases_audio_replacement_candidates_20260505.csv`
- RHVoice/Spomenka で exact-key WAV を生成: `編集ログ/phrases_audio_replacement_generation_20260505.csv`
- 旧prefix/legacy音声を退避: `Esperanto例文5000文_収録音声/archived_replaced_audio_20260505/`
- 退避件数: 10
